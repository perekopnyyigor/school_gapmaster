...
function simplePrompts() {
    ...
    promts[1]="Сделай из данного текста задания, то есть выдели маркером {m} и {f}{m} \n" +
        "те элементы формул которые пользователь должен будет вставить \n" +
     +
        "выделяй по 1 элементу в каждом примере, пример: $$ a=\\cfrac{8000-{m}300{f}{m}}{420}=18,33 м$$\n " ;
